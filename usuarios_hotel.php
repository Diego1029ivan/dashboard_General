    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <img src="img/hotel.png" alt="hotel.png">
                </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tablas de los usuarios administradores de Hoteles</h1>
                    <p class="mb-4">Se presenta la lista de usuarios gerentes, puede modificar cualquier valor que sea necesario.</p>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="botones-tabla">
                                                <a href="./crud/editarusuario.php?id=<?php echo $usuario->id?>"><i class="fas fa-pencil-alt"></i></a>
