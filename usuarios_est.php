        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tablas de todos los usuarios</h1>
                    <p class="mb-4">Se presenta la lista de usuarios para verificar el estado de la cuenta y poder modifcar algún valor.</p>
